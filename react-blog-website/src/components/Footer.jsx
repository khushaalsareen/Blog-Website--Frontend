            ...
            <div className='grid mb-8 lg:grid-cols-6'>
                <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                    ...
                    <ul className='mt-2 space-y-2'>
                        ...
                        <li>
                            <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Personel</a>
                        </li>
                        <li>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                    ...
                    <form className='mt-4 flex flex-col md:flex-row'>
                        <input type="text" name="emailID" id="emailID" className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none' />
                    ...
                    <p className='mt-4 text-sm text-gray-500'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Perferendis voluptas voluptatem sapiente voluptatibus accusantium, beatae asperiores illo alias ratione ipsum ea facere eveniet magni adipisci nemo neque dignissimos officiis soluta.
                    </p>
                    </div>
            </div>
